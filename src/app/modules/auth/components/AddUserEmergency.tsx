...
const AddUserEmergency: FC<any> = ({show, onClose}) => {
            ...
            <Row className='m-10'>
                ...
                <Col lg={12} md={12} sm={12}>
                    <Form.Group>
                        ...
                        {validPhone && touchedPhoneInput ? (
                            <Form.Label className='text-primary'>Teléfono válido</Form.Label>
                        ) : !validPhone && touchedPhoneInput ? (
                            <Form.Label className='text-danger'>Teléfono no válido</Form.Label>
                        ) : null}
                    </Form.Group>
                </Col>
                ...
                <Col lg={12} md={12} sm={12}>
                    <Form.Group>
                        ...
                        <p>
                            *Debe tener por lo menos 6 caracteres, con letras mayúsculas, letras
                            minúsculas, números y almenos un caracter especial*
                        </p>
                        <Form.Control
                            type='password'
                            className={'mb-4'}
...
export default AddUserEmergency
