...
const Sitio: FC<sitio> = (props) => {
  ...
  return (
    ...
    <div className="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-xs-12">
      ...
      <Card style={{ backgroundColor: '#1e1e2d', padding: 20, margin: '20px', width: '95%', height: '100%' }}>

        <Card.Img variant='top' src={`${props.portada_path}`} className='mb-5 card-img-top img1' style={{ width: "100%", height: "260px" }} />
        <div className='card-body'>
          <div className='d-flex flex-row' style={{ justifyContent: 'space-between',marginLeft:'-20px' }}>
          ...
          <Card.Text className='text-muted' style={{marginLeft:'-20px' }}>{props.ubicacion}</Card.Text>
          

        </div>
        <div className='d-flex flex-row' style={{ justifyContent: 'space-between',marginTop:'-40px' }}>
